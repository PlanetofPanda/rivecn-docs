...
## [​](#creating-a-node-script) Creating a Node Script

1. [Create a new script](/docs/scripting/creating-scripts) and select **Node** as the type.
2. [Add it to the scene](/docs/scripting/creating-scripts#adding-scripts-to-your-scene).

## [​](#anatomy-of-a-node-script) Anatomy of a Node Script
...
See the [API Reference](/docs/scripting/api-reference/path) for a complete list of drawing utilities.
...
[Data Binding](/docs/editor/data-binding/overview), [Components](/docs/editor/fundamentals/components), and [Script Inputs](/docs/scripting/script-inputs).
...
### [​](#fixed-step-advance) Fixed-Step Advance
...
[Overview](/docs/scripting/protocols/overview)[Layout Scripts](/docs/scripting/protocols/layout-scripts)