---
title: "填充与描边 (Fill and Stroke) - Rive 编辑器"
description: "基础概念 (Fundamentals) 检查器中的“填充与描边 (Fill and Stroke)”部分允许你添加和修改当前选中对象的填充和描边属性。你可以根据需要创建任意数量的填充或描边。"
head:
  - - meta
    - name: keywords
      content: Rive, Rive 中文文档, Rive 编辑器, 基础概念, 填充与描边
---
...
![新建描边 GIF](https://help.rive.app/images/NewStroke.gif)

### [​](#changing-stroke-type) **更改描边类型**

与填充类似，描边也可以设置为纯色、线性渐变或径向渐变。
![更改描边类型 GIF](https://help.rive.app/images/ChangeStrokeType.gif)
...
![启用羽化 GIF](https://help.rive.app/images/EnableFeather.gif)

### [​](#feathering-options) 羽化选项

- **方向 (Direction)**：选择向内 (Inner) 或向外 (Outer) 产生羽化。
![方向 GIF](https://help.rive.app/images/Direction.gif)
- **数值 (Amount)**：控制羽化的强度。
- **空间 (Space)**：
...
[分组技巧 (Group Tips)](https://help.rive.app/editor/fundamentals/group-tips)[编辑顶点 (Edit Vertices)](https://help.rive.app/editor/fundamentals/edit-vertices)