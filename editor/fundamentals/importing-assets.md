...
## [​](#importing-custom-font) Importing Custom Font
...
## [​](#updating-image-assets) Updating image assets
...
#### [​](#copy-and-paste-directly-from-figma) Copy and paste directly from Figma
...
Importing Lottie files is available on the Enterprise plan. [Learn more about our plans and pricing](https://rive.app/pricing).This workflow can introduce risks that vary across customer setups, and implementing them without our guidance can lead to issues in performance, security, or reliability. Helping customers assess and mitigate these risks takes significant time and effort, which is why this level of support is only available on Enterprise.
...
![Image](images/12a13a71-d5d0-4ed2-a1b1-2fe49bbbb9df.webp)
From there, you can drag it into an existing Artboard or drag it into an empty space to create a new Artboard.
![Image](images/49c02a1d-18d9-4937-8ea1-bad52ba9ce4e.webp)
...
![Image](images/9a2b2c37-c330-4323-a4c6-9928fbac8d94.webp)
...
[Freeze and Origin](/docs/editor/fundamentals/freeze-and-origin)[Revision History](/docs/editor/fundamentals/revision-history)