...
![Lottie 资产面板示例](images/12a13a71-d5d0-4ed2-a1b1-2fe49bbbb9df.webp)
然后，你可以将其拖入现有的画板，或者拖入空白区域以创建一个新画板。
![Lottie 拖入舞台示例](images/49c02a1d-18d9-4937-8ea1-bad52ba9ce4e.webp)
...
![Figma 导出设置](images/9a2b2c37-c330-4323-a4c6-9928fbac8d94.webp)
...
[原点与冻结 (Freeze and Origin)](/editor/fundamentals/origin-freeze.md)[版本历史 (Revision History)](/editor/fundamentals/revision-history)