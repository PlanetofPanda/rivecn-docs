...
![Shape Layer](images/shape-and-path-shapelayer.png)
...
![Path Layer](images/shape-and-path-pathlayer.gif)
...
![Path layer Properties](images/shape-and-path-properties.png)
...
[Pen Tool Overview](/docs/editor/fundamentals/pen-tool-overview)[Procedural Shapes](/docs/editor/fundamentals/procedural-shapes)