---
title: "监听器 (Listeners) - Rive 编辑器"
description: "状态机 (State Machines) 监听器让设计师无需编写代码即可创建交互行为。"
head:
  - - meta
    - name: keywords
      content: Rive, Rive 中文文档, Rive 编辑器, 状态机, 监听器
---
...
![创建监听器](https://help.rive.app/images/CleanShot2025-06-12at14.46.58.gif)
...
![选择目标](https://help.rive.app/images/CleanShot2025-06-12at14.52.27.gif)
...
![不透明目标效果](https://help.rive.app/images/CleanShot2025-06-12at15.11.08.gif)
...
![添加监听器动作](https://help.rive.app/images/CleanShot2025-06-12at15.16.20.gif)

## [​](#view-model-change) **视图模型更改**

更新视图模型实例中的值。这是从 Rive 文件向运行时代码通信的首选方式。
![视图模型下拉](https://help.rive.app/images/CleanShot2025-06-12at15.18.21.gif)

### 值 vs 属性
- **Value (值)**：设置为特定值。
![设置值](https://help.rive.app/images/CleanShot2025-06-12at15.24.51.gif)
- **Property (属性)**：设置为另一个视图模型属性的值。
![设置属性](https://help.rive.app/images/CleanShot2025-06-12at15.31.06.gif)

**添加转换器**：可以在属性之间添加转换器（如"加一"转换器）。
![转换器示例](https://help.rive.app/images/CleanShot2025-06-12at15.37.13.gif)
