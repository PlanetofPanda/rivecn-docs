---
title: "检查器 (Inspector) - Rive 编辑器"
description: "检查器位于编辑器的右侧。它显示了 Rive 编辑器中所有对象的所有可编辑属性。 对象的待编辑属性可以在检查器中找到。检查器会根据你选择的对象以及你在编辑器中所处的位置动态变化。"
head:
  - - meta
    - name: keywords
      content: Rive, Rive 中文文档, Rive 编辑器, 界面面板, 检查器
---
...
![检查器示例 Pn](https://help.rive.app/images/inspector.png)
...
![背景颜色设置 Pn](https://help.rive.app/images/backgrounds.png)

**标签 (Tags)**
在背景颜色下方，你可以查看、编辑和向文件添加新标签。在此处了解更多关于标签的信息：[此处](/editor/tagging.md)。
![标签管理 Pn](https://help.rive.app/images/tags.png)

**默认插值 (Default Interpolation)**
标签下方是文件的默认插值设置。
![默认插值设置 Pn](https://help.rive.app/images/default_Int.png)
...
![对齐工具 Pn](https://help.rive.app/images/Align.png)
...
[约束是通过另一个目标对象来控制一个对象属性的一种方式。](https://help.rive.app/editor/manipulating-shapes/constraints)[## 动画模式 (Animate Mode)

[Rive 有两种不同的模式：设计 (Design) 和动画 (Animate)。](https://help.rive.app/editor/animate-mode/overview)
