---
title: "层级面板 (Hierarchy) - Rive 编辑器"
description: "层级面板显示了文件中的所有对象、资产和视图模型。此视图会根据你选择的画板 (Artboard)、组件 (Component) 或选项卡而变化。 要切换不同的面板，请点击所需的面板。"
head:
  - - meta
    - name: keywords
      content: Rive, Rive 中文文档, Rive 编辑器, 界面面板, 层级面板
---
...
要切换不同的面板，请点击所需的面板。
![切换视图 Gi](https://help.rive.app/images/SwitchView.gif)
...
![右键菜单 Pn](https://help.rive.app/images/right_click.png)
...
![数据面板 Pn](https://help.rive.app/images/Data.png)
